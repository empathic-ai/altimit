...
Altimit's Engine is built on top of the Godot Engine, leveraging its cross-platform support and open architecture. It's a fork of the main branch of Godot Engine, but the goal of Altimit is not to diminish from the Godot Engine project whatsoever—rather augment it. We encourage development on the main branch of Godot wherever possible, and you can still reap the core benefits of Altimit by using the core Godot engine.
