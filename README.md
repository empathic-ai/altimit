...
In Altimit, every interaction boils down to <b>data and data changes</b>. This simple embracement is the basis for Altimit's architecutre, enabling it to be extremely flexible and compatible with a plethora of existing protocols.
