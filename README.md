...
Altimit's Engine is built on top of the Godot Engine, leveraging its cross-platform support and open architecture. It's a fork of the main branch of the Godot Engine with a few additional features and optimizations relevant to Altimit. That said, <i>we encourage developers to contribute to the main branch of Godot or the Altimit plugins rather than Altimit's fork of the Godot Engine.</i> This helps limit fracturing between the fork and main branch. Also, you can still reap most of the benefits of Altimit by using the Godot engine + Altimit as a plugin.
