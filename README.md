...
You can think of Altimit as a networking library. But it is also a set of tools built around that library to interface with external applications in a dynamic way.

In Altimit, every interaction boils down to <b>data and data changes</b>. This simple idea is the basis for Altimit's design—enabling it to be maximally flexible and compatible with existing protocols.
