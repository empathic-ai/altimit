...
In some sense, Altimit is a networking framework. But it is also a set of features built <i>around</i> that framework to interface with other systems in a maximally useful way. These features include:
