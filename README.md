...
In Altimit, every interaction boils down to <b>data and data changes</b>. While this might sound pretty ambiguous, this tenet is integral to Altimit's open design—enabling it to be compatible with a plethora of third-party frameworks and protocols.
