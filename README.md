...
<i>Note: I'm in the process of open-sourcing this project. This repository will change over the next few weeks.</i>
...
Note: Whenever possible, developers are highly encouraged to contribute to the main branch of Godot, rather than contributing directly to Altimit's fork of the Godot Engine. This helps limit fragmentation between projects.
