...
Altimit's Engine is built on top of the Godot Engine, leveraging its cross-platform support and open architecture. It's a fork of the main branch of the Godot Engine and an alternative to Altimit's plugins, with a few additional features and optimizations to provide the best possible experience.
