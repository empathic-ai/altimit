...
Altimit's Engine is built on top of the Godot Engine, leveraging its cross-platform support and open architecture. It's a fork of the main branch of the Godot Engine with some additonal features. That said, we encourage developers to contribute to the main branch of Godot whenever possible rather than this one. Also, you can still reap the core benefits of Altimit by using the Godot engine + Altimit as a plugin.
