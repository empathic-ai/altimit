...
namespace Altimit
{
    public static partial class TypeExtensions
    {
        ...
        public static bool EqualObjects(object a, object b, bool isValue = false)
        {
            ...
            if (!type.IsInstanceType() && type.IsStructure())
            {
        ...
        public static IEnumerable<object> GetConstructorProperties(this object instance, bool isFilteredByDB = false)
        {
            return instance.GetATypeInfo().DefaultConstructorInfo.PropertyNames.Select(x => instance.GetProperty(x, isFilteredByDB));
        }
        ...
        public static IEnumerable<Tuple<APropertyInfo, object>> GetPropertiesByInfo(this object instance, bool isFilteredByDB = false)
        {
            if (instance == null)
                yield break;
            ...
            else if (instance.IsStructure())
            {
                ...
                foreach (var propertyInfo in typeInfo.ReplicatedPropertyInfos)
                {
                    yield return new Tuple<APropertyInfo, object>(propertyInfo, instance.GetProperty(propertyInfo.Name, isFilteredByDB));
                }
            }
        }
