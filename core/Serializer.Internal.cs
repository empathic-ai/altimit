...
using Altimit.Serialization.LZ4;
...
namespace Altimit.Serialization
{
    ...
    public static partial class Serializer
    {
        ...
        public static void Serialize(Type type, IBufferWriter<byte> writer, object value, MessagePackSerializerOptions options = null, CancellationToken cancellationToken = default)
        {
            var fastWriter = new MessagePackWriter(writer)
            {
                CancellationToken = cancellationToken,
            };
            Serialize(type, ref fastWriter, value, options);
            fastWriter.Flush();
        }
        ...
        /// <param name="options">The options. Use <c>null</c> to use default options.</param>
        /// <exception cref="MessagePackSerializationException">Thrown when any error occurs during serialization.</exception>
        public static void Serialize(Type type, ref MessagePackWriter writer, object value, MessagePackSerializerOptions options = null)
        {
            ...
            try
            {
                if (options.Compression.IsCompression() && !IsMessagePackFixedSizePrimitiveTypeHelper(value.GetType()))
                {
                    using (var scratchRental = SequencePool.Shared.Rent())
                    {
                        ...
                        ObjectFormatter.Serialize(type, ref scratchWriter, value, options);
                ...
                {
                    ObjectFormatter.Serialize(type, ref writer, value, options);
                    //options.Resolver.GetFormatterWithVerify<T>().Serialize(ref writer, value, options);
                }
            }
            catch (Exception ex)
            {
                throw new MessagePackSerializationException($"Failed to serialize {value.GetType().Name} value.", ex);
            }
            finally
            {
       ...
       /*
        ...
        /// <param name="cancellationToken">A cancellation token.</param>
        /// <exception cref="MessagePackSerializationException">Thrown when any error occurs during serialization.</exception>
        public static void Serialize(Type type, Stream stream, object value, MessagePackSerializerOptions options = null, CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
            using (SequencePool.Rental sequenceRental = SequencePool.Shared.Rent())
            {
                Serialize(type, sequenceRental.Value, value, options, cancellationToken);
        ...
        /// <exception cref="MessagePackSerializationException">Thrown when any error occurs during serialization.</exception>
        public static async Task SerializeAsync(Type type, Stream stream, object value, MessagePackSerializerOptions options = null, CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
            using (SequencePool.Rental sequenceRental = SequencePool.Shared.Rent())
            {
        ...
        public static object Deserialize(Type type, in ReadOnlySequence<byte> byteSequence, MessagePackSerializerOptions options = null, CancellationToken cancellationToken = default)
        {
            var reader = new MessagePackReader(byteSequence)
            {
                CancellationToken = cancellationToken,
            };
            return Deserialize(type, ref reader, options);
        }
        ...
        public static object Deserialize(Type type, ref MessagePackReader reader, MessagePackSerializerOptions options = null)
        {
                ...
                if (options.Compression.IsCompression())
                {
                    using (var msgPackUncompressedRental = SequencePool.Shared.Rent())
                    {
                        ...
                        if (TryDecompress(ref reader, msgPackUncompressed))
                        {
                            ...
                            return ObjectFormatter.Deserialize(type, ref uncompressedReader, options);
                            //return ((IMessagePackFormatter<object>)options.Resolver.GetFormatterDynamic(type)).Deserialize(ref uncompressedReader, options);
                        }
                        else
                        {
                            return ObjectFormatter.Deserialize(type, ref reader, options);
                            //return ((IMessagePackFormatter<object>)options.Resolver.GetFormatterDynamic(type)).Deserialize(ref reader, options);
                        }
                    }
                }
                else
            ...
            {
                throw new MessagePackSerializationException($"Failed to deserialize {type.Name} value.", ex);
            }
        }
        ...
        /// <returns>The deserialized value.</returns>
        /// <exception cref="MessagePackSerializationException">Thrown when any error occurs during deserialization.</exception>
        public static object Deserialize(Type type, ReadOnlyMemory<byte> buffer, MessagePackSerializerOptions options = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <returns>The deserialized value.</returns>
        /// <exception cref="MessagePackSerializationException">Thrown when any error occurs during deserialization.</exception>
        public static object Deserialize(Type type, ReadOnlyMemory<byte> buffer, out int bytesRead, CancellationToken cancellationToken = default) => Deserialize(type, buffer, options: null, out bytesRead, cancellationToken);
        ...
        /// <returns>The deserialized value.</returns>
        /// <exception cref="MessagePackSerializationException">Thrown when any error occurs during deserialization.</exception>
        public static object Deserialize(Type type, ReadOnlyMemory<byte> buffer, MessagePackSerializerOptions options, out int bytesRead, CancellationToken cancellationToken = default)
        {
            var reader = new MessagePackReader(buffer)
            {
                CancellationToken = cancellationToken,
            };
            object result = Deserialize(type, ref reader, options);
        ...
        {
            if (TryDeserializeFromMemoryStream(type, stream, options, cancellationToken, out object result))
            {
                return result;
            }
            ...
            using (var sequenceRental = SequencePool.Shared.Rent())
            {
                ...
                return DeserializeFromSequenceAndRewindStreamIfPossible(type, stream, options, sequence, cancellationToken);
            }
        }
        ...
        /// If multiple top-level msgpack data structures are expected on the stream, use <see cref="MessagePackStreamReader"/> instead.
        /// </remarks>
        public static async ValueTask<object> DeserializeAsync(Type type, Stream stream, MessagePackSerializerOptions options = null, CancellationToken cancellationToken = default)
        {
            if (TryDeserializeFromMemoryStream(type, stream, options, cancellationToken, out object result))
            {
                return result;
        ...
        private static bool TryDeserializeFromMemoryStream(Type type, Stream stream, MessagePackSerializerOptions options, CancellationToken cancellationToken, out object result)
        {
            cancellationToken.ThrowIfCancellationRequested();
            if (stream is MemoryStream ms && ms.TryGetBuffer(out ArraySegment<byte> streamBuffer))
            {
                result = Deserialize(type, streamBuffer.AsMemory(checked((int)ms.Position)), options, out int bytesRead, cancellationToken);
        ...
        private static object DeserializeFromSequenceAndRewindStreamIfPossible(Type type, Stream streamToRewind, MessagePackSerializerOptions options, ReadOnlySequence<byte> sequence, CancellationToken cancellationToken)
        {
