...
namespace Altimit.Networking
{
    ...
    /// </summary>
    public class ServerSocketTCP : ISocketServer
    {
        public ILogger Logger {get; set;}
        //private readonly HostTopology _topology;

        private readonly Dictionary<TcpClient, TCPPeer> _connectedPeers;
        ...
        public ServerSocketTCP()// : this(BarebonesTopology.Topology)
        {
            ...
            _connectedPeers = new Dictionary<TcpClient, TCPPeer>();
        ...
        private void HandleConnect(TcpClient socketConnection)
        {
            ...
            var peer = new TCPPeer(socketConnection);
