...
namespace Altimit.UI
{
    public partial class AUI
    {
        ...
        public static Node ToggleGroup<T>(this Node node) where T : Enum
        {
            ...
            {
                node.AddChildren(new ToggleButton() { Name = name, Material = AUI.Purple, UseShadow = false });
            }
#endif
            return node;    
        }
        ...
        */
        ...
        /*
        public static Node HList(this Node go, Anchor alignment)
        {
...
//#endif
        ...
        //TODO: see BackButton class for further needed additions
        /*
        public static Button BackButton(this Button node)
        {
        ...
        */
        ...
        public static Control MaskButton(this Control node, Sprite sprite = null)
        {
#if TEMP
            return node.Scale().Button().RoundImage(AUI.SmallSize).Shadow().SoftMask(false).AddChildren(
                        new Image() { Sprite = sprite, Material = AUI.Masked }.OnHeld(x=>x.SetMargin())
                    );
#endif
            return node;
        }
...
//#endif
        ...
        public static Node Text(this Node go, Material material, Anchor alignment = Anchor.UpperLeft)
        {
            return go.Text(null, material, alignment, false);
        }

        public static Node Text(this Node go, Anchor alignment, Material material = null)
        {
            return go.Text(null, material, alignment, false);
        }
        ...
        public static Node Text(this Node node, string text = null, Material material = null, Anchor textAnchor = Anchor.UpperLeft, bool isClear = false, bool includeChildren = false)
        {
#if TEMP
            if (material == null)
                material = Default;
