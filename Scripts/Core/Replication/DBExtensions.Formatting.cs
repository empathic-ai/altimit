...
namespace Altimit
{
    public static partial class DBExtensions
    {
        ...
        public static string ToString(this Database db)
        {
            var globeString = "";
        ...
        public static string ToFormattedString(this object instance, Database instanceDatabase, FormatType formatType, int maxDepth = 10)
        {
            if (instance == null)
                return LocalToString(null);
        ...
        public static void SetSnapshot(this Database globe, Dictionary<AID, object> globalInstancesByID)
        {
