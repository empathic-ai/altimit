...
namespace Altimit.Networking
{
    ...
    public partial class ReplicationSM : SessionModule<ReplicationAM, IReplicationSM>, IReplicationSM
    {
        ...
        bool isLocked = false;
        InstanceDatabase InstanceDB => replicationAM.InstanceDB;
        ...
        public virtual void OnPropertyChanged(object instance, string propertyName, object oldProperty)
        {
            ...
            if (OS.LogReplication)
                Logger.Log($"Property changed named {instance.GetPropertyInfo(propertyName)} on instance with an ID of {instance.GetInstanceID()} with value {value}.");
        ...
        */
        ...
        public void SetAuthority(object instance, bool hasAuthority)
        {
            ...
            if (replicationAM.IsOwner(instance))
                peerSession.Get<IReplicationSM>().SetAuthority(instance, hasAuthority);
        }
