...
namespace Altimit.Networking
{
        ...
        /*
    {
        ...
        public override async void Init()
        {
            ...
            await App.Get<P2PClientAM>().CompletionSource.Task;
        ...
        public async Task<object> GetInstance(AID instanceID)//, Dictionary<AID, object> resolvedSubInstances)
        {
            ...
            {
                instanceOnboarded.AddTask(instanceID);
                ...
                session.Peer.Get<IReplicationSM>().RetrieveInstance(instanceID);
            }

            var instance = await instanceOnboarded.AddOrGetTask(instanceID);
