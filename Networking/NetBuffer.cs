    ...
    internal class NetBuffer
    {
        ...
        public void ReadBytes(byte[] buffer, uint count)
        {
            ...
            for (ushort index = 0; (uint)index < count; ++index)
                buffer[(int)index] = this.m_Buffer[(this.m_Pos + (uint)index)];
            this.m_Pos += count;
        }
        ...
        public void ReadChars(char[] buffer, uint count)
        {
            ...
            for (ushort index = 0; (uint)index < count; ++index)
                buffer[(int)index] = (char)this.m_Buffer[(this.m_Pos + (uint)index)];
            this.m_Pos += count;
        }
        ...
        public void WriteByte2(byte value0, byte value1)
        {
            ...
            this.m_Buffer[(this.m_Pos + 1U)] = value1;
            this.m_Pos += 2U;
        }
        ...
        public void WriteByte4(byte value0, byte value1, byte value2, byte value3)
        {
            ...
            this.m_Buffer[(this.m_Pos)] = value0;
            this.m_Buffer[(this.m_Pos + 1U)] = value1;
            this.m_Buffer[(this.m_Pos + 2U)] = value2;
            this.m_Buffer[(this.m_Pos + 3U)] = value3;
            this.m_Pos += 4U;
        }
        ...
        public void WriteByte8(byte value0, byte value1, byte value2, byte value3, byte value4, byte value5, byte value6, byte value7)
        {
            ...
            this.m_Buffer[(this.m_Pos + 2U)] = value2;
            this.m_Buffer[(this.m_Pos + 3U)] = value3;
            this.m_Buffer[(this.m_Pos + 4U)] = value4;
            this.m_Buffer[(this.m_Pos + 5U)] = value5;
            this.m_Buffer[(this.m_Pos + 6U)] = value6;
            this.m_Buffer[(this.m_Pos + 7U)] = value7;
            this.m_Pos += 8U;
        }
